...
# -------------------------------------------------------------#
# Description: Sextant that converts XY coordinates to and from
# ingame Sextant Coordinates. Not perfectly accurate, but good.
# There is a MIB function that allows you to select a MIB or TMAP
# and it will then display it on the clickable MeesaJarJar_RuneBookAtlas_Map
# -------------------------------------------------------------#
# START CONFIG ------------------------------------------------#
