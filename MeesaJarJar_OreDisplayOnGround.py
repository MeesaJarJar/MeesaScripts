...
# -------------------------------------------------------------#
# Description: Meesa Jar Jars Ore Displayer. Works with other
# script called MeesaJarJar_DisplayOreIngameOverNodes.py 
# Takes ore location X, and Y along with ore type and creates 
# fake phantom objects in client above the ore location 
# that indicates what ore type spawns there.
# This file holds your ore locations in this format:
# 1362,2050,0,copper,copper,green,1 
# -------------------------------------------------------------#
# START CONFIG ------------------------------------------------#

filename = "C:/Program Files (x86)/UOForever/UO/Forever/Data/Client/ore_locations_markers.csv"
