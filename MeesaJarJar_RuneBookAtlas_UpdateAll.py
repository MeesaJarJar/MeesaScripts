...
# -------------------------------------------------------------#
# Description: This is a script that calls the .bat file called 
# YousaPlaceThisFileInYourScriptsFolderAndDoubleClickItForMeesaScripts.bat
# This file automatically downloads the entire github repo again if you need to.
# -------------------------------------------------------------#
# START CONFIG ------------------------------------------------#
